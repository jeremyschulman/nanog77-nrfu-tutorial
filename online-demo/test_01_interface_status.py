...
line option.  This file retrieves the device specific "show" output from the
device directly.
"""
...
import nrfupytesteos.nrfu_interface_status as nrfu
...
def device_interfaces_status(device):
    ...
    -------
    dict
        The dictionary output of the "show interfaces" command
    """
...
def test_interface_status(device, device_interfaces_status, testcase):
    ...
    nrfu.test_interface_status(
        device=device,
        actual=device_interfaces_status,
        testcase=testcase)
